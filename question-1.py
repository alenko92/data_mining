...
# 		(c) Explain why  Lambda = 0 (i.e., no regularization) gives abnormally large MSEs for those
# 			three datasets in (b).
#
# Prof. Yijun Zhao
# 09/27/2019
...
for counter in range(len(allInOne)):
	...
	for lambdas in range(len(lambdaList)):
		wMatrix = get_W_Matrix(xTrain_W_Ones, yTrain, lambdaList[lambdas] )
		# Use wMatrix to get the Mean Square Error for both DataSets
